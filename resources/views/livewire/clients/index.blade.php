  ...
  <div id="modal" class="fixed inset-0 flex hidden items-center justify-center bg-black bg-opacity-30">
    <div class="mx-4 w-1/3 rounded-lg bg-white shadow-lg">
      ...
      <div class="flex justify-end p-4">
        <a id="cancelButton"
           class="mr-2 rounded bg-gray-300 px-4 py-2 text-gray-700 hover:bg-gray-400">Отмена
        </a>
        <a id="okButton" class="rounded bg-red-400 px-4 py-2 text-white hover:bg-red-600">Delete
          {{ $client->id }}</a>
      </div>
    </div>
  </div>
